...
class decisionTree:
    ...
    def find_best_feature(self, df, target_col='subconcept', weight_col='weight'):
        ...
        max_igr_features = max_igr_features[:1] if len(max_igr_features) == 1 else max_igr_features[:2][-1:]
    ...
    def decision_tree(self):
        ...
        # import pickle
        # with open(f'./model_without_empty_pickle/{concept_num}_{subconcept_num}_Binary_Tree_Model.pkl', 'rb') as f:
        ...
        # with open(f'./model_without_empty_pickle/{concept_num}_{subconcept_num}_Type_Tree_Model.pkl', 'rb') as f:
    ...
    def execute(self, intersection=True):
        ...
        self.result_binary['tree_subconcept_set'] = self.result_binary['tree_subconcept'].apply(
